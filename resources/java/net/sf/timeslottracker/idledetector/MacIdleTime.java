...
public class MacIdleTime {
  ...
  public interface ApplicationServices extends Library {
     ...
     * @param eventType
     *          the event type to access. To get the elapsed time since the
     *          previous input event: keyboard, mouse, or tablet, specify
     ...
     *      /QuartzEventServicesRef/Reference/reference.html#//apple_ref/c/func/
