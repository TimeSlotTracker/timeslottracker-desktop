 ...
 */
public class TimeSlotAttributeTableModel extends AbstractTableModel {
  ...
  public TimeSlotAttributeTableModel(LayoutManager layoutManager) {
    this.layoutManager = layoutManager;
    Locale locale = layoutManager.getTimeSlotTracker().getLocale();
    rows = new Vector();
    columns = new Column[2];
    columns[0] = new Column(
        layoutManager.getCoreString("attributes.timeSlot.table.column.type"),
        125, JLabel.LEFT);
    columns[1] = new Column(
        layoutManager.getCoreString("attributes.timeSlot.table.column.value"),
        360, JLabel.LEFT);
  }
