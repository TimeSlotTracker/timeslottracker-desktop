...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" >
        ...
        <fo:root line-stacking-strategy="font-height" font-family="MS Gothic, FreeSans, NotoSansGothic-Regular, UnBatang, TakaoPGothic, Pagul">
            ...
            <fo:page-sequence force-page-count="no-force" master-reference="report" white-space-collapse="false">
                <fo:flow flow-name="body">
                    ...
                    <fo:block xsl:use-attribute-sets="blk.font.big.bold.underlined">
    ...
    <xsl:template match="timeslot">
        <xsl:if test="not(./duration/seconds='0')">
            <fo:list-item>
                <fo:list-item-label end-indent="label-end()">
                    <fo:block>
                        <fo:inline xsl:use-attribute-sets="blk.font.sym">♦</fo:inline>
                    </fo:block>
                </fo:list-item-label>
                <fo:list-item-body start-indent="body-start()">
                    <fo:block>
    ...
    <!-- styles -->
    <xsl:attribute-set name="blk.font.sym">
        <xsl:attribute name="font-family">Symbol</xsl:attribute>
        <xsl:attribute name="font-size">10pt</xsl:attribute>
    </xsl:attribute-set>

    <xsl:attribute-set name="blk.font.big.bold.underlined">
        <xsl:attribute name="font-size">16pt</xsl:attribute>
        <xsl:attribute name="font-weight">bold</xsl:attribute>
        <xsl:attribute name="font-style">underline</xsl:attribute>
    </xsl:attribute-set>
